...
public class SampleCommandLineRunner implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Page<Site> sites = siteResource.getMyUserAccountSitesPage(Pagination.of(1, 10));
		for (Site site: sites.getItems()) {
			_log.info("SITE: " + site.getName());
		}
